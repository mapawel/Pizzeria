...
import { PizzaStore } from './Kitchen-service/Pizzas/Pizza-store.class';
...
import { IngredientsStore } from './Kitchen-service/Ingredients/Ingredients-store.class';
...
const mainService = CustomerService.getInstance();
const discounts = DiscountStore.getInstance();
const orders = OrdersStore.getInstance();
